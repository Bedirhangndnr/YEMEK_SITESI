<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="KategoriEkle.aspx.cs" Inherits="YEMEKTARIFISITESI.KategoriEkle" %>
    ...
    <table id="tblForm" style="width: 100%;">
        ...
        <tr>
            ...
            <td>
                ...
                <br />
                <asp:Label ID="lbl_KategoriEklemeBasariliYadaDegil" runat="server" Text="Label" Visible="False"></asp:Label>
