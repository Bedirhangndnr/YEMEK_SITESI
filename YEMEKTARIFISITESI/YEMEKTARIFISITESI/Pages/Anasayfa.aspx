<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="YEMEKTARIFISITESI.Anasayfa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row" style="width=1000px">
        ...
        <asp:GridView runat="server" ID="grdYemekler" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
           
            <Columns>
                <asp:BoundField DataField="YemekAd" HeaderText="ADI"/>
            </Columns>
