<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Kategoriler.aspx.cs" Inherits="YEMEKTARIFISITESI.Kategoriler" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:GridView ID="GridView1" runat="server" Width="1419px">
        <EmptyDataTemplate>
            s<br /> b<br /> v<br /> df<br />
        </EmptyDataTemplate>
    </asp:GridView>
