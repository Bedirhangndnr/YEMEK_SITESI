                    ...
                    <tr style="border-bottom: 2px solid">
                        ...
                        <td class="auto-style3">
                          <%--                              <asp:LinkButton Text="SİL" style="margin-right: 10px; margin-top: 7px; margin-bottom: 7px" OnCommand="lblbtn_Sil" CommandArgument='<%# Eval("Yemekid") %>' CssClass="btn btn-danger" runat="server" />
                            ...
                            <asp:LinkButton style="margin-right: 10px; margin-top: 7px; margin-bottom: 7px" class="btn btn-danger"  Text="sil" runat="server" OnCommand="Unnamed_Command" CommandArgument='<%# Eval("Yemekid") %>'/>
                            <asp:LinkButton style="margin-right: 10px; margin-top: 7px; margin-bottom: 7px" class="btn btn-danger" Text="onayla" runat="server" OnCommand="Unnamed_Command1" CommandArgument='<%# Eval("Yemekid") %>'/>
                            <asp:LinkButton style="margin-right: 10px; margin-top: 7px; margin-bottom: 7px" class="btn btn-danger" Text="onay kaldır" runat="server" OnCommand="Unnamed_Command2" CommandArgument='<%# Eval("Yemekid") %>'/>
