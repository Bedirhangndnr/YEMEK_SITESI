<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="yemekDetay.aspx.cs" Inherits="YEMEKTARIFISITESI.yemekDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <strong>
        <asp:Label ID="Label4" runat="server" CssClass="auto-style2" Text="Label"></asp:Label>
    </strong>
    <div class="row">
