<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="KategoriDuzenle.aspx.cs" Inherits="YEMEKTARIFISITESI.KategoriDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 100%;">
        ...
        <tr>
            <td class="auto-style3">Kategori Adet:</td>
            <td __designer:mapid="8">
                <asp:TextBox ID="txtbx_KategoriAdet" runat="server" ClientIDMode="Static"  required data-parsley-no-focus data-parsley-error-message="Please enter a message."></asp:TextBox>
            </td>
        </tr>
        <tr>
